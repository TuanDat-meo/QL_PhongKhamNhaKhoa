...
public class ThongKeDoanhThuController {
    ...
    private ThongKeDoanhThuPanel doanhThuView;

    public ThongKeDoanhThuController(ThongKeDoanhThuPanel view) {
        this.doanhThuView = view;
        initConnection();
    }
    ...
    public void thongKeDoanhThuTheoNgay(Date tuNgay, Date denNgay) {
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(doanhThuView, "Lỗi truy vấn thống kê doanh thu theo ngày!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }

        doanhThuView.hienThiThongKe(dataThongKe);
    }
    ...
    public void thongKeDoanhThuTheoTuanTong(Date tuNgay, Date denNgay) {
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(doanhThuView, "Lỗi truy vấn thống kê doanh thu theo tuần!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public void thongKeDoanhThuTheoThang(int nam, int thang) {
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(doanhThuView, "Lỗi truy vấn thống kê doanh thu theo tháng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public void thongKeDoanhThuTheoNam(int nam) {
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(doanhThuView, "Lỗi truy vấn thống kê doanh thu theo năm!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public void thongKeDoanhThuTheoCacNgay(List<Date> danhSachNgay) {
        ...
        if (danhSachNgay.isEmpty()) {
            doanhThuView.hienThiThongKeChiTiet(dataThongKeChiTiet);
            return;
        }
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(doanhThuView, "Lỗi truy vấn thống kê chi tiết theo ngày!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public void thongKeDoanhThuTheoCacThangTrongNam(List<Date> danhSachNgayDauThang) {
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(doanhThuView, "Lỗi truy vấn thống kê chi tiết theo tháng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
