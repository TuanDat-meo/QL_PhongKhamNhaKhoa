...
public class GiaoDienKhachHang extends JFrame {
    ...
    public GiaoDienKhachHang(NguoiDung user) {
        this.loggedInUser = user;
        setTitle("Nha Khoa SmileCare - Cổng Thông Tin Khách Hàng");
        setSize(1200, 700);
...
//            
            ...
            // Highlight menu item mặc định
            highlightMenuItem("Đặt Lịch Hẹn");
        } catch (Exception e) {
            e.printStackTrace();
